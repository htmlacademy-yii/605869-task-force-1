...
<section class="content-view">
    <div class="user__card-wrapper">
        <div class="user__card">
            <img src="<?= Html::encode($user->getAvatar()); ?>" width="120" height="120" alt="<?= Html::encode($user->name); ?>: Аватар пользователя <?= Html::encode($user->name); ?>">
        ...
        <div class="user__card-general-information">
            <div class="user__card-info">
                ...
                <?php
                    if ($user->profiles->phone || $user->profiles->email || $user->profiles->skype)
                    {
                        ?>
                ...
                if ($user->photos)
                {
                    ...
                    <div class="user__card-photo">
                        ...
                        <?php foreach ($user->photos as $photo):?>
                            <a href="#">
                                <img src="<?= $photo->name; ?>" width="85" height="86" alt="Фото работы"></a>
                        <?php endforeach; ?>
                    </div>
                    <?php
                }
                ...
                <div class="content-view__feedback-wrapper reviews-wrapper">
                    <?php foreach ($user->opinions as $opinion): ?>
                        <div class="feedback-card__reviews">
                            <p class="link-task link">Задание <a href="<?= BaseUrl::to(['tasks/view/', 'id' => $opinion->task->id]); ?>" class="link-regular">«<?= Html::encode($opinion->task->name); ?>»</a></p>
                            <div class="card__review">
                                <a href="#"><img src="<?= Html::encode($opinion->task->executor->getAvatar()); ?>" width="55" height="54"></a>
                                <div class="feedback-card__reviews-content">
                                    <p class="link-name link"><a href="<?= BaseUrl::to(['users/view/', 'id' => $opinion->task->executor->id]); ?>" class="link-regular"><?= Html::encode($opinion->task->executor->name); ?></a></p>
                                    <p class="review-text">
                                        <?= Html::encode($opinion->comment); ?>
                                    </p>
                                </div>
