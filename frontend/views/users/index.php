    ...
    <div class="content-view__feedback-card user__search-wrapper">
        <div class="feedback-card__top">
            <div class="user__search-icon">
                <a href="#"><img src="./img/<?= $user->getProfiles()->avatar ?>" width="65" height="65"></a>
                <span><?= count($user->getTasks()); ?> заданий</span>
                <span>6 отзывов</span>
            </div>
            <div class="feedback-card__top--name user__search-card">
                ...
                <b>4.25</b>
                <p class="user__search-content"><?= $user->getProfiles()->about; ?></p>
            </div>
