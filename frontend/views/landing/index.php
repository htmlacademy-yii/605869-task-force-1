...
<div class="landing-container">
    <div class="landing-top">
        ...
        <a href="<?= Yii::$app->urlManager->createUrl(['registration/index']); ?>"><button class="button">Создать аккаунт</button></a>
    </div>
    ...
    <div class="landing-bottom">
        <div class="landing-bottom-container">
            ...
            <div class="landing-task">
                ...
                <div class="landing-task-description">
                    <h3><a href="#" class="link-regular"><?= StringHelper::truncate($task->name, 20); ?></a></h3>
        ...
        <div class="landing-bottom-container">
            <a href="<?= Yii::$app->urlManager->createUrl(['tasks/index']); ?>">
