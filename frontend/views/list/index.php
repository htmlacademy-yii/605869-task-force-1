...
<section class="menu-toggle">
    <ul class="menu-toggle__list">
        <li class="menu-toggle__item menu-toggle__item--completed <?= $status == Task::STATUS_COMPLETED ? 'menu_toggle__item--current' : '' ?>">
            ...
            <a href="<?= BaseUrl::to(['list/index/', 'status' => Task::STATUS_COMPLETED]); ?>">
                Завершённые
            </a>
        </li>
            ...
            <div class="menu-toggle__svg-wrapper">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect opacity="0.01" x="24" y="24" width="24" height="24" transform="rotate(180 24 24)"
                          fill="white"/>
                    <path d="M12 6C12.5523 6 13 5.55228 13 5V3C13 2.44772 12.5523 2 12 2C11.4477 2 11 2.44772 11 3V5C11 5.55228 11.4477 6 12 6Z"
                          fill="white"/>
                    <path d="M21 11H19C18.4477 11 18 11.4477 18 12C18 12.5523 18.4477 13 19 13H21C21.5523 13 22 12.5523 22 12C22 11.4477 21.5523 11 21 11Z"
                          fill="white"/>
                    <path d="M6 12C6 11.4477 5.55228 11 5 11H3C2.44772 11 2 11.4477 2 12C2 12.5523 2.44772 13 3 13H5C5.55228 13 6 12.5523 6 12Z"
                          fill="white"/>
                    <path d="M6.22 4.99995C5.81407 4.61611 5.17384 4.63402 4.79 5.03995C4.40616 5.44588 4.42407 6.08611 4.83 6.46995L6.27 7.85995C6.46525 8.04848 6.72875 8.14955 7 8.13995C7.27219 8.13891 7.53219 8.02696 7.72 7.82995C8.10772 7.43991 8.10772 6.80999 7.72 6.41995L6.22 4.99995Z"
                          fill="white"/>
                    <path d="M17 8.14C17.2575 8.13898 17.5046 8.03869 17.69 7.86L19.13 6.47C19.4946 6.08908 19.5007 5.49053 19.1441 5.10217C18.7874 4.71382 18.1905 4.66911 17.78 5L16.34 6.42C15.9523 6.81004 15.9523 7.43997 16.34 7.83C16.5131 8.01272 16.7488 8.12342 17 8.14Z"
                          fill="white"/>
                    <path d="M12 18C11.4477 18 11 18.4477 11 19V21C11 21.5523 11.4477 22 12 22C12.5523 22 13 21.5523 13 21V19C13 18.4477 12.5523 18 12 18Z"
                          fill="white"/>
                    <path d="M17.73 16.14C17.3324 15.7561 16.6988 15.7673 16.315 16.165C15.9312 16.5626 15.9424 17.1961 16.34 17.58L17.78 19C17.9654 19.1786 18.2125 19.2789 18.47 19.28C18.7407 19.2815 19.0005 19.1733 19.19 18.98C19.3793 18.7922 19.4858 18.5366 19.4858 18.27C19.4858 18.0033 19.3793 17.7477 19.19 17.56L17.73 16.14Z"
                          fill="white"/>
                    <path d="M6.27 16.14L4.83 17.53C4.64069 17.7178 4.5342 17.9734 4.5342 18.24C4.5342 18.5066 4.64069 18.7622 4.83 18.95C5.0195 19.1433 5.27929 19.2516 5.55 19.25C5.79651 19.2521 6.03512 19.1631 6.22 19L7.66 17.61C8.05765 17.2262 8.06884 16.5926 7.685 16.195C7.30116 15.7974 6.66765 15.7862 6.27 16.17V16.14Z"
                          fill="white"/>
                    <path d="M12 8C9.79086 8 8 9.79086 8 12C8 14.2091 9.79086 16 12 16C14.2091 16 16 14.2091 16 12C16 9.79086 14.2091 8 12 8V8Z"
                          fill="white"/>
                </svg>
            </div>
            <a href="<?= BaseUrl::to(['list/index/', 'status' => Task::STATUS_NEW]); ?>">
                Новые
            </a>
        </li>
        <li class="menu-toggle__item menu-toggle__item--active <?= $status == Task::STATUS_IN_WORK ? 'menu_toggle__item--current' : '' ?>">
            <div class="menu-toggle__svg-wrapper">
            ...
            <a href="<?= BaseUrl::to(['list/index/', 'status' => Task::STATUS_IN_WORK]); ?>">
                Активные
            </a>
        </li>
        <li class="menu-toggle__item menu-toggle__item--canceled <?= $status == Task::STATUS_CANCELED ? 'menu_toggle__item--current' : '' ?>">
            ...
            <a href="<?= BaseUrl::to(['list/index/', 'status' => Task::STATUS_CANCELED]); ?>">
                Отменённые
            </a>
        </li>
        <li class="menu-toggle__item menu-toggle__item--hidden <?= $status == Task::STATUS_EXPIRED ? 'menu_toggle__item--current' : '' ?>">
            ...
            <!-- все задания со статусом "НА ИСПОЛНЕНИИ", у которых истек срок исполнения-->
            <a href="<?= BaseUrl::to(['list/index/', 'status' => Task::STATUS_EXPIRED]); ?>">
                Просроченные
            </a>
        </li>
    </ul>
