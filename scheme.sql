...
CREATE TABLE IF NOT EXISTS `TaskForce`.`replies` (
  ...
  INDEX `fk_response_executor_idx` (`user_id` ASC),
...
CREATE TABLE IF NOT EXISTS `TaskForce`.`specialization` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_specialization_user_idx` (`user_id` ASC),
  INDEX `fk_specialization_category_idx` (`category_id` ASC),
...
CREATE TABLE IF NOT EXISTS `TaskForce`.`profiles` (
  ...
  `user_id` INT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_profiles_city_idx` (`city_id` ASC),
  INDEX `fk_profiles_user_idx` (`user_id` ASC),
  INDEX `fk_profiles_specializ_idx` (`specialization_id` ASC),
